...
GVAR(clientSettingsTemp) call (uiNamespace getVariable "CBA_fnc_deleteNamespace");
GVAR(clientSettingsTemp) = nil;

GVAR(serverSettingsTemp) call (uiNamespace getVariable "CBA_fnc_deleteNamespace");
GVAR(serverSettingsTemp) = nil;

GVAR(missionSettingsTemp) call (uiNamespace getVariable "CBA_fnc_deleteNamespace");
