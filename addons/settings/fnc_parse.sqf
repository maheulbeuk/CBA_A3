...

{
    ...
    _setting = ((_statement select [0, _statement find "="]) call (uiNamespace getVariable "CBA_fnc_leftTrim")) call (uiNamespace getVariable "CBA_fnc_rightTrim");
    _value = ((_statement select [(_statement find "=") + 1]) call (uiNamespace getVariable "CBA_fnc_leftTrim")) call (uiNamespace getVariable "CBA_fnc_rightTrim");
